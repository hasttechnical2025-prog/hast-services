...
<style>
  ...
  * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  ...
  /* ---- TRANG 1 ---- */
  .p1 { display: flex; gap: 8mm; }
  .p1-left { width: 40%; display: flex; flex-direction: column; align-items: center; }
  .logo-big { width: 90%; max-height: 46mm; object-fit: contain; }
  .mays { display: flex; align-items: center; justify-content: center; margin: 4mm 0; width: 100%; }
  .mays img { max-height: 48mm; max-width: 100%; object-fit: contain; }
  .inst { border: 1.5px solid #111; border-radius: 8px; padding: 4mm 5mm; width: 100%; font-size: 12.5pt; line-height: 1.5; }
  .inst div { margin: 0.4mm 0; }

  .p1-right { flex: 1; border: 1.5px solid #111; border-radius: 4px; padding: 5mm; display: flex; flex-direction: column; }
  .letterhead { width: 100%; max-height: 16mm; object-fit: contain; display: block; }
  .r-title-row { display: flex; justify-content: space-between; align-items: center; margin: 2mm 0 3mm; }
  .r-phong { font-size: 12pt; font-weight: bold; }
  .qr { width: 28mm; height: 28mm; }
  .r-title { text-align: center; font-size: 30pt; font-weight: bold; letter-spacing: 1px; margin: 1mm 0 4mm; }
  .info { border: 1.2px solid #111; border-radius: 10px; padding: 3mm 4mm; font-size: 12.5pt; line-height: 1.9; }
  .info b.kh { font-size: 14pt; }
  .info .lbl { font-weight: bold; }
  .two { display: flex; gap: 4mm; margin-top: 3mm; }
  .two .b { flex: 1; border: 1.2px solid #111; border-radius: 4px; text-align: center; padding: 2mm; }
  .two .b .h { font-weight: bold; font-size: 12pt; }
  .two .b .v { font-size: 15pt; font-weight: bold; margin-top: 1mm; }
  .row-b { border: 1.2px solid #111; border-radius: 4px; padding: 2mm 3mm; margin-top: 3mm; font-size: 12.5pt; }
  .row-b .lbl { font-weight: bold; }
  .cb { display: inline-flex; align-items: center; gap: 1.5mm; margin-right: 5mm; }
  .cb .bx { display: inline-block; width: 4mm; height: 4mm; border: 1.2px solid #111; text-align: center; line-height: 3.6mm; font-size: 10pt; }
  .print-date { margin-top: auto; padding-top: 3mm; font-size: 11pt; }
  .print-date .lbl { font-weight: bold; }

  /* ---- TRANG 2 ---- */
  .p2-head { display: flex; justify-content: space-between; align-items: center; margin-bottom: 3mm; }
  .p2-logo { height: 13mm; object-fit: contain; }
  .p2-head .mm { font-size: 13pt; } .p2-head .mm b { font-size: 15pt; }
  .grid { display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(3, 1fr); gap: 0; border: 1.5px solid #111; height: 182mm; }
  .cell { border: 0.8px solid #111; padding: 2.5mm 3mm; font-size: 11pt; display: flex; flex-direction: column; }
  .cell-date { text-align: center; margin-bottom: 1mm; }
  .cell .ln { margin: 0.6mm 0; }
  .cell .dot { display: inline-block; border-bottom: 1px dotted #333; min-width: 60%; }
  .cell .sign { margin-top: auto; display: flex; justify-content: space-around; font-weight: bold; font-size: 10.5pt; }
</style></head><body>
...
<div class="page">
  <div class="p2-head">
    <img class="p2-logo" src="/sotheodoi/logo-slogan.png" alt="" onerror="this.style.display='none'">
