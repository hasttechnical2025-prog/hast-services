...
export const TAB_TREE: { key: string, label: string, subs: TabSub[], alwaysOn?: boolean }[] = [
  ...
  { key: 'kho_hang', label: 'Kho hàng', subs: [{ key: 'ton_kho', label: 'Tồn kho' }, { key: 'dat_hang', label: 'Đặt hàng' }, { key: 'thong_ke', label: 'Thống kê nhập' }, { key: 'gia_niem_yet', label: 'Giá niêm yết' }, { key: 'may_thue', label: 'Kho máy thuê' }, { key: 'phieu_de_nghi', label: 'Phiếu đề nghị' }] },
  {
