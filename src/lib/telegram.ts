...
export async function sendTelegramMessage(chatId: string, text: string, replyMarkup?: any): Promise<{ success: boolean; messageId?: number }> {
  ...
  if (await isBaoTri()) return { success: false }
