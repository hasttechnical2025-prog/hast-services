...
-- ============================================================
-- MIGRATION 27: Đăng ký nghỉ phép / ốm của KTV
-- ============================================================
...
-- ============================================================
-- MIGRATION 28: Lịch bảo trì theo tháng + tạm dừng theo dõi
-- ============================================================
...
-- ============================================================
-- MIGRATION 29: Mốc bắt đầu theo dõi bảo trì (máy lắp giữa năm)
-- ============================================================
...
-- ============================================================
-- MIGRATION 30: Thời gian xử lý phiếu (lead time KTV)
-- ============================================================
...
-- ===== MIGRATION 42: Nguồn nhận việc (giao trực tiếp vs KTV tự nhận) =====
...
-- ===== MIGRATION 43: Backfill ngay_xuat_hd (khôi phục thẻ Kanban biến mất) =====
...
-- ===== MIGRATION 44: Đối soát công nợ lịch sử trước 01/08/2026 =====
...
-- ===== MIGRATION 46: Người lập hóa đơn =====
...
-- ===== MIGRATION 47: Thu tiền theo số hóa đơn =====
...
-- ============================================================================
-- MIGRATION 63: hang_ve_ma_thuc (nhận hàng theo mã thực — đặt A về B)
-- ============================================================================
...
-- ===== MIGRATION 82: soct_thu_tien (thu tiền xác thực, Pha 2 lệnh xuất) =====
...
-- ===== MIGRATION 83: soct_lenh_xuat.ly_do_tra (kế toán trả lại lệnh KD) =====
...
-- ===== MIGRATION 84: soct_lenh_xuat.tren_kanban + nguoi_ban_giao_id (giai đoạn Nháp) =====
...
-- ===== MIGRATION 85: hd_lo (lô đẩy Kanban) =====
